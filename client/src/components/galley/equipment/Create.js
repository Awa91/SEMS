...
const CreateGalleyEquip = (props) => {
  ...
  const onSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8082/api/galley/equipment", galleyEquip)
      .then((res) => {
        setGalleyEquip({
          name: "",
          manufacturer: "",
      ...
      .catch((err) => {
        console.log("Error in Create galley equipment!");
      });
  };
...
export default CreateGalleyEquip;
